...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception {
        ...
        //then
        Order cancelOrder = orderRepository.findById(orderId).orElse(null);

        assertEquals("주문 취소시 상태는 CANCEL", OrderStatus.CANCEL, cancelOrder.getStatus());
        assertEquals("주문 취소시 상품은 그만큼 재고가 다시 증가해야 한다", 10, book.getStockQuantity());
    }
